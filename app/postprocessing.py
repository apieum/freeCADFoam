...
class Postprocessing(object):
    def __init__(self, parent, with_gui=True):
        self.Object = parent.newObject("App::DocumentObjectGroupPython", "Postprocessing")
        self.ObjectProxy = _PostprocessingProxy(self.Object)
        if with_gui:
            from gui.postprocessing import ViewProviderPostprocessing
            self.ViewProvider = ViewProviderPostprocessing(self.Object.ViewObject)

class _PostprocessingProxy(object):
    ...
    def execute(self, fp):
        FreeCAD.Console.PrintMessage("Recompute Python Postprocessing feature\n")
