...
class Preprocessing(object):
    def __init__(self, parent, with_gui=True):
        self.Object = parent.newObject("App::DocumentObjectGroupPython", "Preprocessing")
        self.ObjectProxy = _PreprocessingProxy(self.Object)
        if with_gui:
            from gui.preprocessing import ViewProviderPreprocessing
            self.ViewProvider = ViewProviderPreprocessing(self.Object.ViewObject)

class _PreprocessingProxy(object):
    ...
    def execute(self, fp):
        FreeCAD.Console.PrintMessage("Recompute Python Preprocessing feature\n")
